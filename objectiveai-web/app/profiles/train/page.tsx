...
export default function ProfileTrainPage() {
  ...
  const [loadFunctionsError, setLoadFunctionsError] = useState<string | null>(null);
  ...
  useEffect(() => {
    async function fetchFunctions() {
      try {
        ...
        setLoadFunctionsError(err instanceof Error ? err.message : "Failed to load functions");
      } finally {
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: isMobile ? "16px" : "24px" }}>
            ...
            <div className="card" style={{ padding: isMobile ? "16px" : undefined }}>
              ...
              {isLoadingFunctions ? (
                ...
                <div style={{ textAlign: "center", padding: "20px", color: "var(--color-error)" }}>
                  {loadFunctionsError}
                </div>
