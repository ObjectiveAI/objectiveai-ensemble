...
function Controls({ onZoomIn, onZoomOut, onFitToContent }) {
  return /* @__PURE__ */ jsxs("div", { className: "ft-controls", children: [
    /* @__PURE__ */ jsx(
      "button",
      {
        ...
        title: "Zoom in",
        "aria-label": "Zoom in",
        children: /* @__PURE__ */ jsx("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", children: /* @__PURE__ */ jsx("path", { d: "M8 3v10M3 8h10", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round" }) })
      }
    ),
    /* @__PURE__ */ jsx(
      "button",
      {
        ...
        title: "Zoom out",
        "aria-label": "Zoom out",
        children: /* @__PURE__ */ jsx("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", children: /* @__PURE__ */ jsx("path", { d: "M3 8h10", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round" }) })
      }
    ),
    /* @__PURE__ */ jsx(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsx("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", children: /* @__PURE__ */ jsx("path", { d: "M2 6V2h4M10 2h4v4M14 10v4h-4M6 14H2v-4", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }) })
      }
    )
  ] });
}
function DetailPanel({ node, modelNames, onClose }) {
  return /* @__PURE__ */ jsxs("div", { className: "ft-detail-panel", role: "dialog", "aria-label": "Node details", children: [
    /* @__PURE__ */ jsxs("div", { className: "ft-detail-header", children: [
      /* @__PURE__ */ jsx("span", { className: "ft-detail-kind", children: kindLabel(node.kind) }),
      /* @__PURE__ */ jsx(
        "button",
        {
    ...
    /* @__PURE__ */ jsx("h3", { className: "ft-detail-title", children: node.label }),
    /* @__PURE__ */ jsxs("div", { className: "ft-detail-state", children: [
      /* @__PURE__ */ jsx(
        "span",
        {
    ...
    node.data.kind === "function" && /* @__PURE__ */ jsx(FunctionDetails, { data: node.data }),
    node.data.kind === "vector-completion" && /* @__PURE__ */ jsx(VectorCompletionDetails, { data: node.data, modelNames }),
    node.data.kind === "llm" && /* @__PURE__ */ jsx(LlmDetails, { data: node.data, modelNames })
  ] });
}
function FunctionDetails({ data }) {
  return /* @__PURE__ */ jsxs("div", { className: "ft-detail-body", children: [
    data.functionId && /* @__PURE__ */ jsx(DetailRow, { label: "Function", value: data.functionId }),
    data.profileId && /* @__PURE__ */ jsx(DetailRow, { label: "Profile", value: data.profileId }),
    /* @__PURE__ */ jsx(DetailRow, { label: "Tasks", value: String(data.taskCount) }),
    data.output !== null && /* @__PURE__ */ jsx(
      DetailRow,
      {
        label: "Output",
    ...
    data.error && /* @__PURE__ */ jsx(DetailRow, { label: "Error", value: data.error, valueColor: "rgb(239, 68, 68)" })
  ] });
}
function VectorCompletionDetails({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "ft-detail-body", children: [
    /* @__PURE__ */ jsx(DetailRow, { label: "Task Index", value: data.taskPath.join(" > ") }),
    /* @__PURE__ */ jsx(DetailRow, { label: "LLMs", value: String(data.voteCount) }),
    data.scores && data.scores.length > 0 && /* @__PURE__ */ jsxs("div", { className: "ft-detail-scores", children: [
      /* @__PURE__ */ jsx("span", { className: "ft-detail-label", children: "Scores" }),
      /* @__PURE__ */ jsx("div", { className: "ft-detail-score-bars", children: data.scores.map((score, i) => /* @__PURE__ */ jsxs("div", { className: "ft-detail-score-bar", children: [
        /* @__PURE__ */ jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxs("span", { className: "ft-detail-score-label", children: [
          (score * 100).toFixed(1),
          "%"
        ] })
      ] }, i)) })
    ] }),
    data.votes && data.votes.length > 0 && /* @__PURE__ */ jsxs("div", { className: "ft-detail-votes", children: [
      /* @__PURE__ */ jsxs("span", { className: "ft-detail-label", children: [
        "Vote Breakdown (",
        data.votes.length,
        ")"
      ] }),
      /* @__PURE__ */ jsx("div", { className: "ft-detail-vote-list", children: data.votes.map((vote, i) => {
        ...
        return /* @__PURE__ */ jsxs("div", { className: "ft-detail-vote-item", children: [
          /* @__PURE__ */ jsxs("div", { className: "ft-detail-vote-header", children: [
            /* @__PURE__ */ jsx("span", { className: "ft-detail-vote-name", children: name }),
            /* @__PURE__ */ jsxs("span", { className: "ft-detail-vote-weight", children: [
              "w=",
              vote.weight.toFixed(2)
            ] })
          ] }),
          (vote.from_cache || vote.from_rng) && /* @__PURE__ */ jsx("span", { className: `ft-detail-vote-badge${vote.from_rng ? " ft-detail-vote-badge-rng" : ""}`, children: vote.from_rng ? "RNG" : "CACHE" }),
          vote.vote.length > 0 && /* @__PURE__ */ jsx("div", { className: "ft-detail-score-bar", style: { height: 14, marginTop: 2 }, children: /* @__PURE__ */ jsx(
            "div",
            {
              className: "ft-detail-score-fill",
              style: {
...
function LlmDetails({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "ft-detail-body", children: [
    ...
    /* @__PURE__ */ jsx(DetailRow, { label: "Weight", value: data.weight.toFixed(3) }),
    data.fromCache && /* @__PURE__ */ jsx(DetailRow, { label: "Source", value: "Cached" }),
    data.fromRng && /* @__PURE__ */ jsx(DetailRow, { label: "Source", value: "RNG (simulated)" }),
    data.vote && data.vote.length > 0 && /* @__PURE__ */ jsxs("div", { className: "ft-detail-scores", children: [
      /* @__PURE__ */ jsx("span", { className: "ft-detail-label", children: "Vote Distribution" }),
      /* @__PURE__ */ jsx("div", { className: "ft-detail-score-bars", children: data.vote.map((v, i) => /* @__PURE__ */ jsxs("div", { className: "ft-detail-score-bar", children: [
        /* @__PURE__ */ jsx(
          "div",
          {
            className: "ft-detail-score-fill",
    ...
    data.streamingText && /* @__PURE__ */ jsxs("div", { className: "ft-detail-text", children: [
      /* @__PURE__ */ jsx("span", { className: "ft-detail-label", children: "Reasoning" }),
      /* @__PURE__ */ jsx("pre", { className: "ft-detail-pre", children: data.streamingText })
    ] })
  ] });
}
function DetailRow({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "ft-detail-row", children: [
    /* @__PURE__ */ jsx("span", { className: "ft-detail-label", children: label }),
    /* @__PURE__ */ jsx("span", { className: "ft-detail-value", style: valueColor ? { color: valueColor } : void 0, children: value })
  ] });
}
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        !data && /* @__PURE__ */ jsx("div", { className: "ft-empty", children: /* @__PURE__ */ jsx("span", { className: "ft-empty-text", children: "Execute a function to see the tree" }) })
      ]
    }
  );
}

export { DEFAULT_CONFIG, FunctionTree, FunctionTreeEngine, NODE_SIZES, SCORE_COLORS, Viewport, buildTree, layoutTree, scoreColor, treeBounds };
